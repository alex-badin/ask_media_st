...
# INIT COHERE
cohere_key = get_creds('cohere_key_prod')
co = cohere.Client(cohere_key)

# INIT PINECONE
pine_key = get_creds('pine_key')
index_name = get_creds('pine_index')
pc = Pinecone(pine_key)
index = pc.Index(index_name)

# INIT OPENAI
openai_key = get_creds('openai_key')
openai.api_key = openai_key

# INIT COHERE
cohere_key = get_creds('cohere_key')
co = cohere.Client(cohere_key)
...
def get_top_pine(request: str=None, request_emb=None, dates: ['%Y-%m-%d',['%Y-%m-%d']]=None, sources=None, stance=None\
    ...
    with open('pinecone_results.log', 'w') as f:
